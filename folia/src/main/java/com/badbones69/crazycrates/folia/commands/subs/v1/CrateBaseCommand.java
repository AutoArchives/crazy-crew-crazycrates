package com.badbones69.crazycrates.folia.commands.subs.v1;
...
import com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent;
...
public class CrateBaseCommand extends BaseCommand {
        ...
        if (crate != null) {
            if (!player.getName().equalsIgnoreCase(sender.getName())) {
                ...
                if (crazyManager.getVirtualKeys(sender, crate) >= amount) {
                    com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent event = new com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent(player, crate, com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent.KeyReceiveReason.TRANSFER, amount);
    ...
    @Permission(value = "crazycrates.command.admin.mass-open", def = PermissionDefault.OP)
    ...
    @Permission(value = "crazycrates.command.admin.force-open", def = PermissionDefault.OP)
    ...
    @SubCommand("set")
    @Permission(value = "crazycrates.command.admin.set-crate", def = PermissionDefault.OP)
    ...
    @Permission(value = "crazycrates.command.admin.give-random-key", def = PermissionDefault.OP)
    ...
    @SubCommand("give")
    @Permission(value = "crazycrates.command.admin.give-key", def = PermissionDefault.OP)
    public void onAdminCrateGive(CommandSender sender, @Suggestion("key-types") String keyType, @Suggestion("crates") String crateName, @Suggestion("numbers") int amount, @Suggestion("online-players") CustomPlayer target) {
        ...
        if (crate.getCrateType() != CrateType.MENU) {
            com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent event = new com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent(person, crate, com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent.KeyReceiveReason.GIVE_COMMAND, amount);
    ...
    @SubCommand("take")
    @Permission(value = "crazycrates.command.admin.take-key", def = PermissionDefault.OP)
    ...
    @SubCommand("giveall")
    @Permission(value = "crazycrates.command.admin.give-all", def = PermissionDefault.OP)
        ...
        if (crate != null) {
            if (crate.getCrateType() != CrateType.MENU) {
                ...
                for (Player onlinePlayer : plugin.getServer().getOnlinePlayers()) {
                    ...
                    com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent event = new com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent(onlinePlayer, crate, PlayerReceiveKeyEvent.KeyReceiveReason.GIVE_ALL_COMMAND, amount);
