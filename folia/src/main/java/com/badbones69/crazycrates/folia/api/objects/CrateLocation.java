...
public class CrateLocation {
    ...
    private final com.badbones69.crazycrates.folia.api.objects.Crate crate;
    private final Location loc;
    
    public CrateLocation(String id, com.badbones69.crazycrates.folia.api.objects.Crate crate, Location loc) {
        this.id = id;
        this.crate = crate;
        this.loc = loc;
    }
