package com.badbones69.crazycrates.folia.api;
...
import com.badbones69.crazycrates.folia.api.enums.BrokeLocation;
...
import com.badbones69.crazycrates.folia.cratetypes.CSGO;
import com.badbones69.crazycrates.folia.listeners.CrateControlListener;
import com.badbones69.crazycrates.folia.listeners.MenuListener;
import com.badbones69.crazycrates.folia.support.libraries.PluginSupport;
import com.badbones69.crazycrates.folia.support.structures.StructureHandler;
import com.badbones69.crazycrates.folia.utils.Methods;
import com.badbones69.crazycrates.folia.listeners.PreviewListener;
import com.badbones69.crazycrates.folia.support.holograms.CMIHologramsSupport;
import com.badbones69.crazycrates.folia.support.holograms.DecentHologramsSupport;
...
public class CrazyManager {
    ...
    private final ArrayList<com.badbones69.crazycrates.folia.api.objects.Crate> crates = new ArrayList<>();

    // A list of all the physical crate locations.
    private final ArrayList<com.badbones69.crazycrates.folia.api.objects.CrateLocation> crateLocations = new ArrayList<>();
    ...
    private final List<com.badbones69.crazycrates.folia.api.enums.BrokeLocation> brokeLocations = new ArrayList<>();

    // The crate that the player is opening.
    private final HashMap<UUID, com.badbones69.crazycrates.folia.api.objects.Crate> playerOpeningCrates = new HashMap<>();
    ...
    private com.badbones69.crazycrates.folia.api.interfaces.HologramController hologramController;
    ...
    public void loadCrates() {
        ...
        if (com.badbones69.crazycrates.folia.support.libraries.PluginSupport.DECENT_HOLOGRAMS.isPluginEnabled()) {
            hologramController = new DecentHologramsSupport();
            plugin.getLogger().info("DecentHolograms support has been enabled.");
        } else if (com.badbones69.crazycrates.folia.support.libraries.PluginSupport.CMI.isPluginEnabled() && CMIModule.holograms.isEnabled()) {
        ...
        for (String crateName : fileManager.getAllCratesNames()) {
            try {
                ...
                ArrayList<com.badbones69.crazycrates.folia.api.objects.Prize> prizes = new ArrayList<>();
                String previewName = file.contains("Crate.Preview-Name") ? file.getString("Crate.Preview-Name") : file.getString("Crate.Name");
                ArrayList<com.badbones69.crazycrates.folia.api.objects.Tier> tiers = new ArrayList<>();
                ...
                if (file.contains("Crate.Tiers") && file.getConfigurationSection("Crate.Tiers") != null) {
                    for (String tier : file.getConfigurationSection("Crate.Tiers").getKeys(false)) {
                        ...
                        tiers.add(new com.badbones69.crazycrates.folia.api.objects.Tier(tier, file.getString(path + ".Name"), file.getString(path + ".Color"), file.getInt(path + ".Chance"), file.getInt(path + ".MaxRange")));
                    }
                }
                ...
                for (String prize : file.getConfigurationSection("Crate.Prizes").getKeys(false)) {
                    com.badbones69.crazycrates.folia.api.objects.Prize altPrize = null;
                    String path = "Crate.Prizes." + prize;
                    ArrayList<com.badbones69.crazycrates.folia.api.objects.Tier> prizeTiers = new ArrayList<>();

                    for (String tier : file.getStringList(path + ".Tiers")) {
                        for (com.badbones69.crazycrates.folia.api.objects.Tier loadedTier : tiers) {
                    ...
                    if (file.contains(path + ".Alternative-Prize")) {
                        if (file.getBoolean(path + ".Alternative-Prize.Toggle")) {
                            altPrize = new com.badbones69.crazycrates.folia.api.objects.Prize("Alternative-Prize",
                    ...
                    prizes.add(new com.badbones69.crazycrates.folia.api.objects.Prize(prize, getDisplayItem(file, prize),
                ...
                crates.add(new com.badbones69.crazycrates.folia.api.objects.Crate(crateName, previewName, crateType, getKey(file), prizes, file, newPlayersKeys, tiers, maxMassOpen, requiredKeys, prizeMessage, holo));
            } catch (Exception e) {
                brokecrates.add(crateName);
        ...
        crates.add(new com.badbones69.crazycrates.folia.api.objects.Crate("Menu", "Menu", CrateType.MENU, new ItemStack(Material.AIR), new ArrayList<>(), null, 0, null, 0, 0, Collections.emptyList(), null));
        ...
        if (locations.getConfigurationSection("Locations") != null) {
            for (String locationName : locations.getConfigurationSection("Locations").getKeys(false)) {
                try {
                    ...
                    com.badbones69.crazycrates.folia.api.objects.Crate crate = getCrateFromName(locations.getString("Locations." + locationName + ".Crate"));

                    if (world != null && crate != null) {
                        crateLocations.add(new com.badbones69.crazycrates.folia.api.objects.CrateLocation(locationName, crate, location));
                        ...
                        brokeLocations.add(new com.badbones69.crazycrates.folia.api.enums.BrokeLocation(locationName, crate, x, y, z, worldName));
                        brokeAmount++;
                    }
    ...
    public void cleanDataFile() {
        ...
        if (data.contains("Players")) {
            ...
            for (String uuid : data.getConfigurationSection("Players").getKeys(false)) {
                ...
                for (com.badbones69.crazycrates.folia.api.objects.Crate crate : getCrates()) {
     ...
     */
    public void openCrate(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate, KeyType keyType, Location location, boolean virtualCrate, boolean checkHand) {
        if (crate.getCrateType() != CrateType.MENU) {
            if (!crate.canWinPrizes(player)) {
                player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.NO_PRIZES_FOUND.getMessage());
        ...
        if (crate.getFile() != null) com.badbones69.crazycrates.folia.utils.Methods.broadCastMessage(crate.getFile(), player);
        ...
        switch (crate.getCrateType()) {
            case MENU -> {
                ...
                if (openMenu) MenuListener.openGUI(player); else player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.FEATURE_DISABLED.getMessage());
            }
            case COSMIC -> com.badbones69.crazycrates.folia.cratetypes.Cosmic.openCosmic(player, crate, keyType, checkHand);
            case CSGO -> CSGO.openCSGO(player, crate, keyType, checkHand);
            case ROULETTE -> com.badbones69.crazycrates.folia.cratetypes.Roulette.openRoulette(player, crate, keyType, checkHand);
            case WHEEL -> com.badbones69.crazycrates.folia.cratetypes.Wheel.startWheel(player, crate, keyType, checkHand);
            case WONDER -> com.badbones69.crazycrates.folia.cratetypes.Wonder.startWonder(player, crate, keyType, checkHand);
            case WAR -> com.badbones69.crazycrates.folia.cratetypes.War.openWarCrate(player, crate, keyType, checkHand);
            case QUAD_CRATE -> {
                ...
                com.badbones69.crazycrates.folia.support.structures.StructureHandler handler = new StructureHandler(crateSchematic.schematicFile());
                com.badbones69.crazycrates.folia.api.objects.CrateLocation crateLocation = getCrateLocation(location);
                com.badbones69.crazycrates.folia.api.managers.QuadCrateManager session = new QuadCrateManager(player, crate, keyType, crateLocation.getLocation(), lastLocation, checkHand, handler);

                session.startCrate();
            }
            case FIRE_CRACKER -> {
                if (com.badbones69.crazycrates.folia.listeners.CrateControlListener.inUse.containsValue(location)) {
                    player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.QUICK_CRATE_IN_USE.getMessage());
                    removePlayerFromOpeningList(player);
                    return;
                } else {
                    if (virtualCrate) {
                        player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.CANT_BE_A_VIRTUAL_CRATE.getMessage());
                        removePlayerFromOpeningList(player);
                        return;
                    } else {
                        com.badbones69.crazycrates.folia.listeners.CrateControlListener.inUse.put(player, location);
                        com.badbones69.crazycrates.folia.cratetypes.FireCracker.startFireCracker(player, crate, keyType, location, hologramController);
                    }
                }
            }
            case QUICK_CRATE -> {
                if (com.badbones69.crazycrates.folia.listeners.CrateControlListener.inUse.containsValue(location)) {
                    ...
                    if (virtualCrate && location.equals(player.getLocation())) {
                        ...
                        com.badbones69.crazycrates.folia.cratetypes.QuickCrate.openCrate(player, location, crate, keyType, hologramController);
                    }
                }
            }
            case CRATE_ON_THE_GO -> {
                if (virtualCrate) {
                    ...
                    if (takeKeys(1, player, crate, keyType, true)) {
                        ...
                        if (prize.useFireworks()) com.badbones69.crazycrates.folia.utils.Methods.firework(player.getLocation().add(0, 1, 0));
     ...
     */
    public ArrayList<com.badbones69.crazycrates.folia.api.objects.CrateLocation> getCrateLocations() {
    ...
    public boolean isCrateLocation(Location loc) {
        for (com.badbones69.crazycrates.folia.api.objects.CrateLocation crateLocation : getCrateLocations()) {
     ...
     */
    public com.badbones69.crazycrates.folia.api.objects.CrateLocation getCrateLocation(Location loc) {
        for (com.badbones69.crazycrates.folia.api.objects.CrateLocation crateLocation : getCrateLocations()) {
            if (crateLocation.getLocation().equals(loc)) {
     ...
     */
    public void addCrateLocation(Location location, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        FileConfiguration locations = FileManager.Files.LOCATIONS.getFile();
        ...
        crateLocations.add(new com.badbones69.crazycrates.folia.api.objects.CrateLocation(id, crate, location));
    ...
    public void removeCrateLocation(String id) {
        ...
        FileManager.Files.LOCATIONS.saveFile();
        com.badbones69.crazycrates.folia.api.objects.CrateLocation location = null;
     ...
     */
    public ArrayList<com.badbones69.crazycrates.folia.api.objects.Crate> getCrates() {
        return crates;
    }
     ...
     */
    public com.badbones69.crazycrates.folia.api.objects.Crate getCrateFromName(String name) {
        for (com.badbones69.crazycrates.folia.api.objects.Crate crate : getCrates()) {
     ...
     */
    public void givePrize(Player player, com.badbones69.crazycrates.folia.api.objects.Prize prize, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        if (prize != null) {
            ...
            for (ItemStack item : prize.getItems()) {
                ...
                if (item == null) {
                    ...
                    player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.PRIZE_ERROR.getMessage(placeholders));
                    continue;
                }

                if (!com.badbones69.crazycrates.folia.utils.Methods.isInventoryFull(player)) {
            ...
            for (com.badbones69.crazycrates.folia.api.objects.ItemBuilder item : prize.getItemBuilders()) {
                com.badbones69.crazycrates.folia.api.objects.ItemBuilder clone = new com.badbones69.crazycrates.folia.api.objects.ItemBuilder(item);

                if (com.badbones69.crazycrates.folia.support.libraries.PluginSupport.PLACEHOLDERAPI.isPluginEnabled()) {
            ...
            for (String command : prize.getCommands()) { // /give %player% iron %random%:1-64
                ...
                if (com.badbones69.crazycrates.folia.support.libraries.PluginSupport.PLACEHOLDERAPI.isPluginEnabled()) command = PlaceholderAPI.setPlaceholders(player, command);

                com.badbones69.crazycrates.folia.utils.Methods.sendCommand(command.replaceAll("%player%", player.getName()).replaceAll("%Player%", player.getName()).replaceAll("%reward%", quoteReplacement(prize.getDisplayItemBuilder().getUpdatedName())).replaceAll("%crate%", crate.getCrateInventoryName()));
            }
            ...
            if (!crate.getPrizeMessage().isEmpty() && prize.getMessages().isEmpty()) {
                for (String message : crate.getPrizeMessage()) {
                    ...
                    com.badbones69.crazycrates.folia.utils.Methods.sendMessage(player, message.replaceAll("%player%", player.getName()).replaceAll("%Player%", player.getName()).replaceAll("%reward%", quoteReplacement(prize.getDisplayItemBuilder().getName())).replaceAll("%crate%", crate.getCrateInventoryName()), false);
                }
     ...
     */
    public boolean addOfflineKeys(String player, com.badbones69.crazycrates.folia.api.objects.Crate crate, int keys) {
        try {
            FileConfiguration data = FileManager.Files.DATA.getFile();
     ...
     */
    public boolean takeOfflineKeys(String player, com.badbones69.crazycrates.folia.api.objects.Crate crate, int keys) {
        try {
            FileConfiguration data = FileManager.Files.DATA.getFile();
            player = player.toLowerCase();
            int playerKeys = 0;
        ...
        if (data.contains("Offline-Players." + name)) {
            for (com.badbones69.crazycrates.folia.api.objects.Crate crate : getCrates()) {
                if (data.contains("Offline-Players." + name + "." + crate.getName())) {
                    com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent event = new com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent(player, crate, com.badbones69.crazycrates.folia.api.events.PlayerReceiveKeyEvent.KeyReceiveReason.OFFLINE_PLAYER, 1);
     ...
     */
    public void addPlayerToOpeningList(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
     ...
     */
    public com.badbones69.crazycrates.folia.api.objects.Crate getOpeningCrate(Player player) {
     ...
     */
    public com.badbones69.crazycrates.folia.api.objects.Crate getCrateFromKey(ItemStack item) {
     ...
     */
    public boolean isKeyFromCrate(ItemStack item, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        if (crate.getCrateType() != CrateType.MENU) {
            if (item != null && item.getType() != Material.AIR) {
                return com.badbones69.crazycrates.folia.utils.Methods.isSimilar(item, crate);
            }
        }
     ...
     */
    public boolean hasPhysicalKey(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate, boolean checkHand) {
     ...
     */
    public ItemStack getPhysicalKey(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        for (ItemStack item : player.getOpenInventory().getBottomInventory().getContents()) {
            if (item == null || item.getType() == Material.AIR) continue;

            if (com.badbones69.crazycrates.folia.utils.Methods.isSimilar(item, crate)) {
                return item;
            }
        }
     ...
     */
    public HashMap<com.badbones69.crazycrates.folia.api.objects.Crate, Integer> getVirtualKeys(Player player) {
        HashMap<com.badbones69.crazycrates.folia.api.objects.Crate, Integer> keys = new HashMap<>();
     ...
     */
    public HashMap<com.badbones69.crazycrates.folia.api.objects.Crate, Integer> getVirtualKeys(String playerName) {
        HashMap<com.badbones69.crazycrates.folia.api.objects.Crate, Integer> keys = new HashMap<>();
        FileConfiguration data = FileManager.Files.DATA.getFile();
     ...
     * Get the amount of virtual keys a player has.
     */
    public int getVirtualKeys(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
     ...
     */
    public int getPhysicalKeys(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        int keys = 0;
        for (ItemStack item : player.getOpenInventory().getBottomInventory().getContents()) {
            if (item == null || item.getType() == Material.AIR) continue;
     ...
     */
    public Integer getTotalKeys(Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
     ...
     */
    public boolean takeKeys(int amount, Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate, KeyType keyType, boolean checkHand) {
        switch (keyType) {
            case PHYSICAL_KEY -> {
                        ...
                        if (item != null) {
                            if (isKeyFromCrate(item, crate)) {
                                ...
                                if ((takeAmount - keyAmount) >= 0) {
                                    com.badbones69.crazycrates.folia.utils.Methods.removeItemAnySlot(player.getInventory(), item);
    ...
    public void addVirtualKeys(int amount, Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        String uuid = player.getUniqueId().toString();
        int keys = getVirtualKeys(player, crate);
        FileManager.Files.DATA.getFile().set("Players." + uuid + ".Name", player.getName());
     ...
     */
    public void addKeys(int amount, Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate, KeyType keyType) {
        switch (keyType) {
            case PHYSICAL_KEY -> {
                if (com.badbones69.crazycrates.folia.utils.Methods.isInventoryFull(player)) {
                    if (giveVirtualKeysWhenInventoryFull) {
                        ...
                        if (fullMessage) player.sendMessage(com.badbones69.crazycrates.folia.api.enums.settings.Messages.CANNOT_GIVE_PLAYER_KEYS.getMessage().replaceAll("%amount%", String.valueOf(amount)).replaceAll("%key%", crate.getName()));
                    } else {
     ...
     */
    public void setKeys(int amount, Player player, com.badbones69.crazycrates.folia.api.objects.Crate crate) {
        String uuid = player.getUniqueId().toString();
        FileManager.Files.DATA.getFile().set("Players." + uuid + ".Name", player.getName());
    ...
    private ItemStack getKey(FileConfiguration file) {
        ...
        return new com.badbones69.crazycrates.folia.api.objects.ItemBuilder().setMaterial(id).setName(name).setLore(lore).setGlow(glowing).build();
    }

    private com.badbones69.crazycrates.folia.api.objects.ItemBuilder getDisplayItem(FileConfiguration file, String prize) {
        String path = "Crate.Prizes." + prize + ".";
        com.badbones69.crazycrates.folia.api.objects.ItemBuilder itemBuilder = new com.badbones69.crazycrates.folia.api.objects.ItemBuilder();
        ...
        try {
            ...
            return new com.badbones69.crazycrates.folia.api.objects.ItemBuilder().setMaterial(Material.RED_TERRACOTTA).setName("&c&lERROR").setLore(Arrays.asList("&cThere is an error", "&cFor the reward: &c" + prize));
        }
    }

    private List<com.badbones69.crazycrates.folia.api.objects.ItemBuilder> getItems(FileConfiguration file, String prize) {
        return com.badbones69.crazycrates.folia.api.objects.ItemBuilder.convertStringList(file.getStringList("Crate.Prizes." + prize + ".Items"), prize);
    }
