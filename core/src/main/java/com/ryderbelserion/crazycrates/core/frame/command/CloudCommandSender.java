...
import com.ryderbelserion.crazycrates.core.frame.utils.AdventureUtils;
 ...
 */
public abstract class CloudCommandSender implements ForwardingAudience.Single {

    private final Object sender;

    public <T> CloudCommandSender(@NotNull T sender) {
        this.sender = sender;
    }
