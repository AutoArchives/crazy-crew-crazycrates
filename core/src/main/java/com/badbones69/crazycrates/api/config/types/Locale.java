package com.badbones69.crazycrates.api.config.types;
...
public class Locale implements SettingsHolder {
    ...
    public static final Property<String> HELP_PAGE_HEADER = PropertyInitializer.newProperty(path + "help.page.header", "<dark_gray>────────</dark_gray> <gold>CrazyCrates Help {page}</gold> <dark_gray>────────</dark_gray>");

    public static final Property<String> HELP_PAGE_FOOTER = PropertyInitializer.newProperty(path + "help.page.footer", "<dark_gray>────────</dark_gray> <gold>CrazyCrates Help {page}");
