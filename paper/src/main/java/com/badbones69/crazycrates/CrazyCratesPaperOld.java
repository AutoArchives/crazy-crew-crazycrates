...
public class CrazyCratesPaperOld extends JavaPlugin {

    private CrazyCrates instance;

    @NotNull
    public static CrazyCratesPaperOld get() {
        return JavaPlugin.getPlugin(CrazyCratesPaperOld.class);
    }
    ...
    public void onEnable() {
        ...
        PaperServer server = new PaperServer(null, null, null);
        ...
        // Load keys.
        this.keyManager.loadKeys(server);
