...
public class BukkitCrateManager {
    ...
    /**
     * Get crate by crate name for placeholders
     *
     ...
     */
    public boolean isKeyFromCrate(String crateName, ItemStack item) {
        return getKeyFromCrate(crateName, item) != null;
    }
    ...
    /**
     * @return a set of loaded crate schematics.
     */
    public Set<CrateSchematic> getCrateSchematics() {
        return Collections.unmodifiableSet(this.crateSchematics);
    }
