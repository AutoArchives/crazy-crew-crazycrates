...
public class PluginSupport implements SettingsHolder {
    ...
    public static final Property<Boolean> PLACEHOLDERAPI_SUPPORT = PropertyInitializer.newProperty("support.placeholderapi", false);
    ...
    public static final Property<Boolean> HOLOGRAMS_SUPPORT_ENABLED = PropertyInitializer.newProperty("support.holograms.toggle", false);
    ...
    public static final Property<HologramSupport> HOLOGRAMS_SUPPORT_TYPE = PropertyInitializer.newProperty(HologramSupport.class, "support.holograms.type", HologramSupport.decent_holograms);
}